...
public class TelaPersonalizar extends JFrame {
    ...
    public TelaPersonalizar(String nome, String preco, String corHex) {
        ...
        this.txtNomePeca.setText(nome);
        this.txtPrecoPeca.setText(preco);
        try {
            this.previewCamisa.setBackground(Color.decode("#" + corHex));
        } catch (Exception e) {
            this.previewCamisa.setBackground(Color.WHITE);
        }
    }
    ...
    private void configurarTela() {
        ...
        JPanel navbar = new JPanel(new MigLayout("insets 15", "[left][grow][center][center][center][center][grow]", ""));
        ...
        Color[] listaCores = {Color.WHITE, Color.BLACK, Color.RED, Color.BLUE, 
        ...
        btnCriarEstampa.addActionListener(e -> { new TelaEstampa().setVisible(true); dispose(); });
        ...
        painelDireito.add(new JLabel("selecione a sua estampa") {{ setForeground(Color.WHITE); }});
        ...
        btnEnviar.addActionListener(e -> {
            ...
            if (nome.isEmpty() || preco.isEmpty()) {
                ...
                boolean ok = ehEdicao ? produtoController.atualizarProduto(nomeAntigo, nome, preco, hexCor) : produtoController.cadastrarProduto(nome, preco, hexCor);
                if (ok) {
